...
export function PurchaseInfoCard({
  ...
  return (
    <section className="space-y-2.5" aria-labelledby="purchase-info-title">
      <h2
      ...
      <div className="overflow-hidden rounded-2xl border border-app-border bg-app-surface/75 shadow-lg shadow-black/15">
        ...
        <div className="border-t border-app-border p-3">
          <p className="mb-1.5 text-[0.78rem] font-medium leading-none text-app-muted">
            Data da compra
          </p>
          <button
            type="button"
            className="flex h-11 w-full items-center gap-3 rounded-xl border border-app-border bg-app-bg/35 px-3 text-left text-[0.86rem] font-semibold text-app-text transition-colors hover:bg-app-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
          >
            <CalendarDays
              aria-hidden="true"
...
function PurchaseTextField({
  ...
  return (
    <label htmlFor={id} className="block min-w-0 space-y-1.5">
      <span className="block text-[0.78rem] font-medium leading-none text-app-muted">
        {label}
      </span>
      <span className="relative block">
        ...
        <input
          ...
          className={cn(
            "h-11 w-full rounded-xl border border-app-border bg-app-bg/35 pl-9 pr-3 text-[0.86rem] text-app-text outline-none transition-colors",

...
import type { CreditCard, User } from '@prisma/client';
...
export class CreditCardsController {
  ...
  @Get(':id')
  findOne(@CurrentUser() user: User, @Param('id') id: string): Promise<CreditCard> {
  ...
  @Delete(':id')
  remove(@CurrentUser() user: User, @Param('id') id: string): Promise<CreditCard> {
